...
function Sidebar() {
  ...
  return (
    <div className={styles.sidebar}>
      <div
        className={
          hide ? styles.menuIconControlHide : styles.menuIconControlActive
        }
      >
      ...
      <div className={styles.IconControl} style={{ marginLeft: "1rem" }}>
        {hide ? (
          <div onClick={() => handleChangeHide()}>
            <div className={styles.hide}>
              <KeyboardArrowDownIcon className={styles.hideIcon} />
            </div>
            <inline>Xem thêm</inline>
          </div>
        ) : (
          <div onClick={() => handleChangeHide()}>
            <div className={styles.hide}>
              <KeyboardArrowUpIcon className={styles.hideIcon} />
            </div>
            <inline>Ẩn bớt</inline>
          </div>
        )}
      </div>
      ...
      <div className={styles.shortcut}>
        ...
        >
          ...
          <inline>youtube</inline>
        </a>
        <a className={styles.IconShortcut} href="https://www.instagram.com/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
          ...
          <inline>instagram</inline>
        </a>
        <a className={styles.IconShortcut} href="https://www.google.com/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
